...
const tmps = [
  {prodNum: 1, top_img: "/api/upload/brandintro/img_brand02_01.jpg", 
...
const tmps3 = [
  {prodNum: 1, cont_img: "/api/upload/brandintro/img_brand02_02.jpg", 
...
const tmps3_1 = [
  {prodNum: 1, cont_img: "/api/upload/brandintro/img_brand02_03.jpg", 
...
const tmps4 = [
  {prodNum: 1, cont_img: "/api/upload/brandintro/img_brand02_04.jpg", 
  main_tit: "Quality 품질",
  ...
  {prodNum: 2, cont_img: "/api/upload/brandintro/img_brand02_05.jpg", 
  ...
  {prodNum: 3, cont_img: "/api/upload/brandintro/img_brand02_06.jpg", 
  ...
  {prodNum: 4, cont_img: "/api/upload/brandintro/img_brand02_07.jpg", 
  main_tit: "Value 가치",
      ...
      <div className="contents">
        <div className="inner">
          <ul className="inner_btn">
            <li>
              <NavLink to="/story/brandintro" role="button">
                맥도날드 소개
              </NavLink>
            </li>
            <li>
              <NavLink to="/story/brandhistory" role="button" className="on">
                맥도날드 철학 및 역사
              </NavLink>
            </li>
          </ul>
