    ...
    <div class = "BrandIntro">
      <div class="contents">
        <div class="inner">
          <ul class="inner_btn">
            <li>
              <NavLink to="/brandintro" role="button" class="on">
                맥도날드 소개
              </NavLink>
            </li>
            <li>
